CC = gcc
OBJS = main.o Game.o Autofill.o Parser.o Board.o FileManager.o ILP.o MainAux.o Stack.o ValidBoard.o Generate.o
EXEC = sudoku-console
...
main.o: main.c Game.h Parser.h ValidBoard.h Autofill.h ILP.h
