...
void hint(int **solution, int y, int x);/*hint for appropriate value of cell*/
void autofill(int **arr,int dimension,int row_per_block,int col_per_block);/* fill cells with only one legal value*/
